...
# 创建文件
set(config_file_source_path "${CMAKE_CURRENT_SOURCE_DIR}/assets/rc/rc.h.in")
set(config_file_target_path "${extra_source_path}/rc.h")
configure_file("${config_file_source_path}" "${config_file_target_path}" @ONLY)
set(config_file_source_path "${CMAKE_CURRENT_SOURCE_DIR}/assets/rc/rc.c.in")
set(config_file_target_path "${extra_source_path}/rc.c")
configure_file("${config_file_source_path}" "${config_file_target_path}" @ONLY)
set(config_file_source_path "${CMAKE_CURRENT_SOURCE_DIR}/assets/rc/icons.c.in")
