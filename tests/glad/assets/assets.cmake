...
function(read_file_hex)
    ...
    string(REGEX REPLACE "(..)" "0x\\1;" tmp "${tmp}")
    # remove last ;
...
# config 资源文件
set(icons_path      "${CMAKE_CURRENT_LIST_DIR}/icons")
...
# 创建文件
set(config_file_source_path "${CMAKE_CURRENT_LIST_DIR}/rc/rc.h.in")
set(config_file_target_path "${extra_source_path}/rc.h")
configure_file("${config_file_source_path}" "${config_file_target_path}" @ONLY)
set(config_file_source_path "${CMAKE_CURRENT_LIST_DIR}/rc/rc.c.in")
set(config_file_target_path "${extra_source_path}/rc.c")
configure_file("${config_file_source_path}" "${config_file_target_path}" @ONLY)
set(config_file_source_path "${CMAKE_CURRENT_LIST_DIR}/rc/icons.c.in")
set(config_file_target_path "${extra_source_path}/icons.c")
configure_file("${config_file_source_path}" "${config_file_target_path}" @ONLY)