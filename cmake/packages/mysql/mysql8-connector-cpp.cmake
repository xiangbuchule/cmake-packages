...
#   ENABLE_LIB_ONLY:    ON
function(add_mysql8_connector_cpp)
    # params
    ...
    # address
    set(mysql8_repository_url       "https://github.com/mysql/mysql-connector-cpp")
    list(APPEND mysql8_version_list "8.3.0" "8.2.0" "8.1.0" "8.0.33")
    list(APPEND mysql8_hash_list    "8c47fd82ee179582280e6ee823eb58f8066b0fd8101e684c46dfb73010a39664"
    ...
    if(mysql8_version_index GREATER_EQUAL 0)
        set(mysql8_url   "${mysql8_repository_url}/archive/refs/tags/${mysql8_version}.zip")
