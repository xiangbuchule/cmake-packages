...
function(add_freetype2)
    ...
    set("${freetype_name}-includes"     "${freetype_install}/include/freetype2"               PARENT_SCOPE)
    set("${freetype_name}-cmake"        "${freetype_install}/lib/cmake/freetype"    PARENT_SCOPE)
    set("${freetype_name}-pkgconfig"    "${freetype_install}/lib/pkgconfig"         PARENT_SCOPE)
    set("${freetype_name}-root"         "${freetype_install}"                       PARENT_SCOPE)
    ...
    if("${freetype_build_type}" STREQUAL "DEBUG")
        guess_binary_file(name "freetype" lib_suffix "d" bin_suffix "d")
    else()
