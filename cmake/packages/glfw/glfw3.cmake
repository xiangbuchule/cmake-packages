...
function(add_glfw3)
    ...
    # check is build debug/release
    string(TOUPPER "${glfw3_build_type}" glfw3_build_type)
    if(("${glfw3_build_type}" STREQUAL "DEBUG") OR NOT ${glfw3_build_install})
