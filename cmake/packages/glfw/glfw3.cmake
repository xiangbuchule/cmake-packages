...
function(add_glfw3)
    ...
    list(APPEND glfw3_cmake_options "-DGLFW_INSTALL=ON")
    # is install
    if(MSVC)
    ...
    set("${glfw3_name}-cmake"       "${glfw3_install}/lib/cmake/glfw3"  PARENT_SCOPE)
    set("${glfw3_name}-pkgconfig"   "${glfw3_install}/lib/pkgconfig"    PARENT_SCOPE)
    set("${glfw3_name}-root"        "${glfw3_install}"                  PARENT_SCOPE)
    # check is build debug/release
